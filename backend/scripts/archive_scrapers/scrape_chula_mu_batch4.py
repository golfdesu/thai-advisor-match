...
TARGETS=[
    ("Chulalongkorn University","https://www.sc.chula.ac.th/en/academics"),
    ("Chulalongkorn University","https://www.md.chula.ac.th/en/academics"),
    ("Mahidol University","https://www.dt.mahidol.ac.th/en/"),
    ("Mahidol University","https://www.ns.mahidol.ac.th/en/"),
    ("Mahidol University","https://www.eg.mahidol.ac.th/"),
]
...
def main():
    ...
    with engine.connect() as conn:
        for uni in ["Chulalongkorn University","Mahidol University","Chiang Mai University"]:
