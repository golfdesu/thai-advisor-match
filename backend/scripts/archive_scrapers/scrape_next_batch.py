...
QUERIES=[
    ...
    ("Mahidol University","Mahidol University Faculty of ICT programs site:mahidol.ac.th"),
    ("Mahidol University","Mahidol University Faculty of Nursing programs site:mahidol.ac.th"),
    ("Srinakharinwirot University","Srinakharinwirot University programs site:swu.ac.th"),
    ("Suranaree University of Technology","Suranaree University of Technology Institute of Science programs site:sut.ac.th"),
    ("National Institute of Development Administration","NIDA master programs site:nida.ac.th"),
    ("Burapha University","Burapha University Faculty of Science programs site:buu.ac.th"),
]
