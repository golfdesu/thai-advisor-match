...
TARGETS=[
    ("Chiang Mai University", "Chiang Mai University หลักสูตร ปริญญาเอก site:cmu.ac.th"),
    ("Chulalongkorn University", "Chulalongkorn University หลักสูตร ปริญญาเอก site:chula.ac.th"),
    ("Mahidol University", "Mahidol University หลักสูตร ปริญญาเอก site:mahidol.ac.th"),
]
...
def main():
    ...
    for uni, q in TARGETS:
        ...
        for url in urls:
            ...
            time.sleep(4)  # stay under 20/min
        if not all_courses:
            print("  No courses")
            continue
        seen={}
