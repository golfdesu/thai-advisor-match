...
# Many faculties for top missing universities
QUERIES=[
    # Chula
    ("Chulalongkorn University","Chulalongkorn University Faculty of Science programs site:chula.ac.th"),
    ("Chulalongkorn University","Chulalongkorn University Faculty of Medicine programs site:chula.ac.th"),
    ("Chulalongkorn University","Chulalongkorn University Faculty of Law programs site:chula.ac.th"),
    ("Chulalongkorn University","Chulalongkorn University Faculty of Education programs site:chula.ac.th"),
    ("Chulalongkorn University","Chulalongkorn University Faculty of Architecture programs site:chula.ac.th"),
    ("Chulalongkorn University","Chulalongkorn University Faculty of Economics programs site:chula.ac.th"),
    # Mahidol
    ("Mahidol University","Mahidol University Faculty of Medicine Siriraj programs site:mahidol.ac.th"),
    ("Mahidol University","Mahidol University Faculty of Science programs site:mahidol.ac.th"),
    ...
    # CMU (only need 20 more)
    ("Chiang Mai University","Chiang Mai University Faculty of Agriculture programs site:cmu.ac.th"),
    ("Chiang Mai University","Chiang Mai University Faculty of Humanities programs site:cmu.ac.th"),
    # Other low
    ("Thammasat University","Thammasat University Faculty of Engineering programs site:tu.ac.th"),
    ("Kasetsart University","Kasetsart University Faculty of Engineering programs site:ku.ac.th"),
    ("Khon Kaen University","Khon Kaen University Faculty of Engineering programs site:kku.ac.th"),
    ("Prince of Songkla University","Prince of Songkla University Faculty of Engineering programs site:psu.ac.th"),
    ("Burapha University","Burapha University programs site:buu.ac.th"),
    ("Srinakharinwirot University","Srinakharinwirot University Faculty of Education programs site:swu.ac.th"),
]
...
def main():
    ...
    with engine.connect() as conn:
        ...
        for uni in ["Chulalongkorn University","Mahidol University","Chiang Mai University","Thammasat University","Kasetsart University"]:
