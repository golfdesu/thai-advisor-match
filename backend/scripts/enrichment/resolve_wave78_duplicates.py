# -*- coding: utf-8 -*-
"""
Resolve Wave 78 Duplicates & Grounding Merge
============================================
Merges duplicates and consolidates profiles following Wave 78 acquisition:
1. Harmonizing Naresuan University Faculty of Medicine:
   - Ensuring courses in 'courses' table have exact faculty_th aligned with 'คณะแพทยศาสตร์'.
2. Synchronizing English university name (university) from TH_TO_EN_CANONICAL ("Naresuan University").
...
def merge_faculty_pair(primary: FacultyDB, secondary: FacultyDB, db) -> str:
    ...
    nav_boilerplate = ["วิจัย/บริการวิชาการ", "งานวิจัย และงานวิชาการ", "โทรศัพท์", "ติดต่อ", "กยศ.", "ทุนการศึกษา"]
    seen_interests = set()
    cleaned_interests = []
...
def resolve_wave78_duplicates():
    print("=================================================================", flush=True)
    print("🔄 RESOLVING WAVE 78 DUPLICATES & PROFILE MERGING", flush=True)
    print("=================================================================", flush=True)
    ...
    try:
        ...
        # Step 2: Clean anomalous entries, fix slashes in interests, and publication shape for Wave 78
        all_nu_records = db.query(FacultyDB).filter(FacultyDB.id.like("nu_med_%")).all()

        nav_boilerplate = ["วิจัย/บริการวิชาการ", "งานวิจัย และงานวิชาการ", "โทรศัพท์", "ติดต่อ", "กยศ.", "ทุนการศึกษา", "ค่าเทอม"]

        for f in all_nu_records:
        ...
        # Email hygiene & trailing junk removal for Wave 78
        for f in all_nu_records:
            if f.email:
    ...
    print("\n🎉 Wave 78 duplicate resolution completed successfully!")


if __name__ == "__main__":
    resolve_wave78_duplicates()
