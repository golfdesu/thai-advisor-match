# -*- coding: utf-8 -*-
"""
Resolve Wave 70 Duplicates & Grounding Merge
============================================
Merges duplicates and consolidates profiles following Wave 70 acquisition:
1. Intra-university duplicate listings (TU Nursing, TU SocAnth, KMUTT SBT, CMU PH).
2. Harmonizing course-to-faculty parentheticals in courses if needed.
...
def resolve_wave70_duplicates():
    print("=================================================================", flush=True)
    print("🔄 RESOLVING WAVE 70 DUPLICATES & PROFILE MERGING", flush=True)
    print("=================================================================", flush=True)
    ...
    try:
        ...
        # Step 2: Clean anomalous entries, fix slashes in interests, and publication shape for Wave 70
        wave70_prefixes = ["tu_nurse%", "tu_socanth%", "kmutt_sbt%", "cmu_ph%"]
        conditions = [FacultyDB.id.like(p) for p in wave70_prefixes]
    ...
    print("\n🎉 Wave 70 duplicate resolution completed successfully!")


if __name__ == "__main__":
    resolve_wave70_duplicates()
