# -*- coding: utf-8 -*-
"""
Resolve Wave 68 Duplicates & Grounding Merge
============================================
Merges duplicates and consolidates profiles following Wave 68 acquisition:
1. Intra-university duplicate listings (KMITL Liberal Arts, TU PSDS, TU PBIC, CMU SPP, NU Law).
2. Harmonizing course-to-faculty parentheticals in courses (KMITL Business School / KBS).
...
def resolve_wave68_duplicates():
    print("=================================================================", flush=True)
    print("🔄 RESOLVING WAVE 68 DUPLICATES & PROFILE MERGING", flush=True)
    print("=================================================================", flush=True)
    ...
    try:
        ...
        course_mappings = [
            ("สถาบันเทคโนโลยีพระจอมเกล้าเจ้าคุณทหารลาดกระบัง", "วิทยาลัยการบริหารและจัดการ", "คณะบริหารธุรกิจ"),
        ]
        ...
        # Step 2: Clean anomalous entries, fix slashes in interests, and publication shape for Wave 68
        wave68_prefixes = ["kmitl_libarts%", "tu_psds%", "tu_pbic%", "cmu_spp%", "nu_law%"]
        conditions = [FacultyDB.id.like(p) for p in wave68_prefixes]
    ...
    print("\n🎉 Wave 68 duplicate resolution completed successfully!")


if __name__ == "__main__":
    resolve_wave68_duplicates()
