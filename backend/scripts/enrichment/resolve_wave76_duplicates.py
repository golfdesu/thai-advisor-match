# -*- coding: utf-8 -*-
"""
Resolve Wave 76 Duplicates & Grounding Merge
============================================
Merges duplicates and consolidates profiles following Wave 76 acquisition:
1. Harmonizing Bangkok University Courses:
   - Ensuring all 49 courses in 'courses' table have exact faculty_th aligned with the 11 faculties.
2. Synchronizing English university name (university) from TH_TO_EN_CANONICAL ("Bangkok University").
...
def resolve_wave76_duplicates():
    print("=================================================================", flush=True)
    print("🔄 RESOLVING WAVE 76 DUPLICATES & PROFILE MERGING", flush=True)
    print("=================================================================", flush=True)

    db = SessionLocal()
    try:
        # Step 0: Harmonize Course-to-Faculty Naming in courses
        print("\n--- Harmonizing Bangkok University Courses Naming ---", flush=True)
        course_mappings = [
        ...
        # Graduate school courses for Bangkok University
        ...
        for gc in grad_courses:
            if "นิเทศศาสตร" in gc.title_th:
                ...
                harmonized_courses += 1
                print(f"  [Course Harmonization] Graduate School -> คณะนิเทศศาสตร์ ({gc.title_th})")
            elif "การจัดการความรู้" in gc.title_th or "นวัตกรรม" in gc.title_th:
                gc.faculty_th = "คณะการสร้างเจ้าของธุรกิจและการบริหารกิจการ"
                harmonized_courses += 1
                print(f"  [Course Harmonization] Graduate School -> คณะการสร้างเจ้าของธุรกิจและการบริหารกิจการ ({gc.title_th})")
        ...
        # Step 2: Clean anomalous entries, fix slashes in interests, and publication shape for Wave 76
        all_bu_records = db.query(FacultyDB).filter(FacultyDB.id.like("bu_%")).all()

        nav_boilerplate = ["วิจัย/บริการวิชาการ", "งานวิจัย และงานวิชาการ", "วารสารพัฒนศาสตร์", "โทรศัพท์", "ติดต่อ", "กยศ.", "ทุนการศึกษา", "ค่าเทอม"]

        for f in all_bu_records:
        ...
        # Email hygiene & trailing junk removal for Wave 76
        for f in all_bu_records:
            if f.email:
    ...
    print("\n🎉 Wave 76 duplicate resolution completed successfully!")


if __name__ == "__main__":
    resolve_wave76_duplicates()
