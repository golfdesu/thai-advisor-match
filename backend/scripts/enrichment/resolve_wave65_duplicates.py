# -*- coding: utf-8 -*-
"""
Resolve Wave 65 Duplicates & Grounding Merge
============================================
Merges duplicates and consolidates profiles following Wave 65 acquisition:
1. Intra-university duplicate listings (e.g. TU Dentistry, CMU BMEI, RMUTT Engineering).
...
def resolve_wave65_duplicates():
    print("=================================================================", flush=True)
    print("🔄 RESOLVING WAVE 65 DUPLICATES & PROFILE MERGING", flush=True)
    print("=================================================================", flush=True)
    ...
    try:
        ...
        all_wave_records = db.query(FacultyDB).filter(
            FacultyDB.id.like("tu_dent%") | FacultyDB.id.like("cmu_bmei%") | FacultyDB.id.like("rmutt_eng%")
        ).all()
    ...
    print("\n🎉 Wave 65 duplicate resolution completed successfully!")


if __name__ == "__main__":
    resolve_wave65_duplicates()
