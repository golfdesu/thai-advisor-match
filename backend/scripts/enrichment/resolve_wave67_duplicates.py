# -*- coding: utf-8 -*-
"""
Resolve Wave 67 Duplicates & Grounding Merge
============================================
Merges duplicates and consolidates profiles following Wave 67 acquisition:
1. Intra-university duplicate listings (KMUTNB FITM, KMUTNB Applied Arts).
...
8. Harmonizing course-to-faculty parentheticals in courses (SIT, SoA+D, ICT, PSU Phuket, KMITL RAI/SIIE, NIDA GSBA).
...
def resolve_wave67_duplicates():
    print("=================================================================", flush=True)
    print("🔄 RESOLVING WAVE 67 DUPLICATES & PROFILE MERGING", flush=True)
    print("=================================================================", flush=True)

    db = SessionLocal()
    try:
        # Step 0: Harmonize Course-to-Faculty Parentheticals in courses
        print("\n--- Harmonizing Course Parentheticals & Suffixes ---", flush=True)
        course_mappings = [
            ("มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าธนบุรี", "คณะเทคโนโลยีสารสนเทศ (SIT)", "คณะเทคโนโลยีสารสนเทศ"),
            ("มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าธนบุรี", "คณะสถาปัตยกรรมศาสตร์และการออกแบบ (SoA+D)", "คณะสถาปัตยกรรมศาสตร์และการออกแบบ"),
            ("มหาวิทยาลัยบูรพา", "คณะเทคโนโลยีทางทะเล (วิทยาเขตจันทบุรี)", "คณะเทคโนโลยีทางทะเล"),
            ("มหาวิทยาลัยศิลปากร", "คณะเทคโนโลยีสารสนเทศและการสื่อสาร (ICT)", "คณะเทคโนโลยีสารสนเทศและการสื่อสาร"),
            ("มหาวิทยาลัยศิลปากร", "คณะเทคโนโลยีสารสนเทศและการสื่อสาร (ICT ศิลปากร)", "คณะเทคโนโลยีสารสนเทศและการสื่อสาร"),
            ("มหาวิทยาลัยสงขลานครินทร์", "คณะวิทยาศาสตร์และเทคโนโลยีอุตสาหกรรม (วิทยาเขตสุราษฎร์ธานี)", "คณะวิทยาศาสตร์และเทคโนโลยีอุตสาหกรรม"),
            ("มหาวิทยาลัยสงขลานครินทร์", "วิทยาลัยการคอมพิวเตอร์ (วิทยาเขตภูเก็ต)", "วิทยาลัยการคอมพิวเตอร์"),
            ("มหาวิทยาลัยสงขลานครินทร์", "วิทยาลัยการคอมพิวเตอร์ วิทยาเขตภูเก็ต", "วิทยาลัยการคอมพิวเตอร์"),
            ("มหาวิทยาลัยมหิดล", "วิทยาลัยการจัดการ มหาวิทยาลัยมหิดล", "วิทยาลัยการจัดการ"),
            ("สถาบันเทคโนโลยีพระจอมเกล้าเจ้าคุณทหารลาดกระบัง", "คณะวิศวกรรมศาสตร์ (RAI KMITL)", "คณะวิศวกรรมศาสตร์"),
            ("สถาบันเทคโนโลยีพระจอมเกล้าเจ้าคุณทหารลาดกระบัง", "คณะวิศวกรรมศาสตร์ (SIIE)", "คณะวิศวกรรมศาสตร์"),
            ("สถาบันบัณฑิตพัฒนบริหารศาสตร์ (นิด้า)", "คณะบริหารธุรกิจ (GSBA)", "คณะบริหารธุรกิจ"),
        ...
        # Step 2: Clean anomalous entries, fix slashes in interests, and publication shape for Wave 67
        all_wave_records = db.query(FacultyDB).filter(
            FacultyDB.id.like("kmutnb_fitm%") | FacultyDB.id.like("kmutnb_fas%")
        ).all()
    ...
    print("\n🎉 Wave 67 duplicate resolution completed successfully!")


if __name__ == "__main__":
    resolve_wave67_duplicates()
