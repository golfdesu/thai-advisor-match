"""Wave23 ingest: university-enforced + sanitize + grouped dedup + vectorize + local commit."""
...
EXPECT = {
 "spa_tu_scitech_export.py": "ธรรมศาสตร์",
 "spa_cu_spsc_export.py": "จุฬาลงกรณ์",
 "wave23_su_arch_export.py": "ศิลปากร",
 "wave23_ubu_sci_export.py": "อุบล",
 "wave23_mju_bus_export.py": "แม่โจ้",
 "wave23_buu_log_export.py": "บูรพา",
 "wave23_wu_med_export.py": "วลัยลักษณ์",
 "wave23_kmitl_med_export.py": "ลาดกระบัง",
 "wave23_msu_techno_export.py": "มหาสารคาม",
 "wave23_msu_human_export.py": "มหาสารคาม",
}
    ...
    try:
        ...
        if new_members:
            ...
            for m, v in zip(new_members, vecs):
                n += 1
                uid = f"wave23_{n:04d}_{random.randint(100,999)}"
                while uid in have:
                    n += 1; uid = f"wave23_{n:04d}_{random.randint(100,999)}"
                have.add(uid)
