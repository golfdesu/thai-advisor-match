"""Wave33 ingest: SUT-PH discovery + UBU-ICT + WU law/mgmt + PPC + SGtech."""
...
EXPECT = {
 "wave33_sut_publichealth_export.py": ("สุรนารี", {}),
 "wave33_nu_sgtech_export.py": ("นเรศวร", {}),
 "wave33_ubu_sci_export.py": ("อุบล", {}),
 "wave33_wu_law_export.py": ("วลัยลักษณ์", {}),
 "wave33_wu_mgmt_export.py": ("วลัยลักษณ์", {}),
 "wave33_mu_ss_export.py": ("มหิดล", {}),
 "wave33_cu_ppc_export.py": ("จุฬาลงกรณ์", {}),
 "wave33_nida_env_export.py": ("บัณฑิตพัฒนบริหารศาสตร์", {}),
 "wave33_kku_huso_export.py": ("ขอนแก่น", {}),
}
