"""Wave26 ingest: NIDA browser breakthrough + WU allied + IAAI dean. Canonicalizes NIDA label."""
...
JUNK = ["ยินดี", "แสดงความ", "โปรดเกล้า", "องครักษ์", "หมู่", "Bruce Willis",
    "ออกหน่วย", "ข่าว", "ประกาศ", "รับสมัคร", "ติดต่อ", "kingsteruni"]

EXPECT = {
 "wave26_nida_env_export.py": "บัณฑิตพัฒนบริหารศาสตร์",
 "wave26_nida_gspa_export.py": "บัณฑิตพัฒนบริหารศาสตร์",
 "wave26_nida_bus_export.py": "บัณฑิตพัฒนบริหารศาสตร์",
 "wave26_wu_allied_export.py": "วลัยลักษณ์",
 "wave26_kmitl_iaai_export.py": "ลาดกระบัง",
}
    ...
    try:
        ...
        if new_members:
            ...
            for m, v in zip(new_members, vecs):
                n += 1
                uid = f"wave26_{n:04d}_{random.randint(100,999)}"
                while uid in have:
                    n += 1; uid = f"wave26_{n:04d}_{random.randint(100,999)}"
                have.add(uid)
