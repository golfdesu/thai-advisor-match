"""Apply Phase 29 multi-agent recovered authentic official emails to local PostgreSQL.

Phase 29 Target High-Yield Clusters:
- Chula Sasin School of Management (sasin.edu)
- Chula Faculty of Economics (chula.ac.th)
- Chula Faculty of Pharmacy (chula.ac.th)
- Chula Faculty of Nursing (chula.ac.th)
- Chula Vaccine Research Center (chula.ac.th)
- Chula Computer Engineering (chula.ac.th / cp.eng.chula.ac.th)
- Thammasat SIIT (siit.tu.ac.th)
- CMU Mechanical Engineering (cmu.ac.th)
...
DEFAULT_INPUT_FILE = DATA_DIR / "recoverable_official_emails_phase29.json"
...
def main(apply: bool = False, input_file: str | None = None) -> None:
    ...
    try:
        ...
        out_filename = (
            "recovered_official_emails_phase29_apply.json"
            if apply
            else "recovered_official_emails_phase29_dryrun.json"
        )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Apply Phase 29 recovered official emails to PostgreSQL.")
