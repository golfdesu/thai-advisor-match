"""Apply Phase 35 multi-agent recovered authentic official emails to local PostgreSQL.

Phase 35 Target High-Yield Clusters:
- KMUTT - Department of Microbiology (mic.kmutt.ac.th) (9 records)
- KMUTT - School of Information Technology (SIT) (sit.kmutt.ac.th) (7 records)
...
DEFAULT_INPUT_FILE = DATA_DIR / "recoverable_official_emails_phase35.json"
...
def main(apply: bool = False, input_file: str | None = None) -> None:
    ...
    try:
        ...
        out_filename = (
            "recovered_official_emails_phase35_apply.json"
            if apply
            else "recovered_official_emails_phase35_dryrun.json"
        )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Apply Phase 35 recovered official emails to PostgreSQL.")
